# parameters
ARG REPO_NAME="<duckietown_simulatorwrapper>"
ARG DESCRIPTION="<A ROS wrapper that maps wheel commands to actions and observations to camera images on a ROS topic. >"
